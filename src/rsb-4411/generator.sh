...
cd ~/YoctianOS-Distro/src/rsb-4411 && MACHINE=imx6qrsb4411a1 UBOOT_CONFIG=1G DISTRO=fsl-imx-x11 source imx-setup-release.sh -b build_$BUILD_DIR && bash ~/YoctianOS-Distro/script/rsb-4411/User/local_$BUILD_DIR.sh && bash ~/YoctianOS-Distro/script/rsb-4411/User/bblayers_$BUILD_DIR.sh && exec bash
EOF
